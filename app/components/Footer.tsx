    ...
    >
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="pt-6">
          ...
          <div className="flex flex-col items-start justify-between gap-5">
            ...
            <div className="flex gap-2">
              <SocialBtn label="Twitter / X" href="https://x.com/usechangpay">
              ...
              <SocialBtn label="Instagram" href="https://www.instagram.com/usechangpayapp">
        ...
        <p className="text-[12px] text-white/65">Chang Global Technologies LLC is incorporated in Delaware, United States, with business  address at 8 The Green, Suite B, Dover, DE 19901, USA, and registered as a Money Services Business (MSB) with FinCEN under BSA ID: 31000329787645</p>
            ...
            <p className="text-[12px] text-white/65">Chang Global Ventures Ltd is a private company limited by shares, incorporated in Nigeria under the Companies and Allied Matters Act 2020 with Company Registration No. 8994084</p>
      </div>
    </footer>
  );
}
